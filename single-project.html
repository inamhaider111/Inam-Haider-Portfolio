...
<body>
    ...
    <div class="single-project-page-design">
        ...
        <div class="single-project-image">
            <img src="assets/images/projects/single-project.jpg" alt="image">
        </div>
            ...
            <div class="row pt-30">
                <div class="col-lg-6">
                    <div class="single-image wow fadeInUp delay-0-2s">
                        <img src="assets/images/projects/single-project1.jpg" alt="gallery">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="single-image wow fadeInUp delay-0-4s">
                        <img src="assets/images/projects/single-project2.jpg" alt="gallery">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="single-image wow fadeInUp delay-0-6s">
                        <img src="assets/images/projects/single-project3.jpg" alt="gallery">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="single-image wow fadeInUp delay-0-8s">
                        <img src="assets/images/projects/single-project4.jpg" alt="gallery">
                    </div>
                </div>
            </div>
